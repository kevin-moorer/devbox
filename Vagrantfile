...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.box = "centos-63-x64.box"
  ...
  # config.vm.synced_folder "../data", "/vagrant_data"
    config.vm.synced_folder "webroot", "/webroot", type: "nfs"
  # config.vm.share_folder("webroot", "/webroot", "./webroot", :nfs => true)
  ...
  # the file centos63.pp in the manifests_path directory.
  #
